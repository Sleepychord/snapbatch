...
class PDSHRunner(MultiNodeRunner):
    def __init__(self, args, world_info_base64, env_style='slurm'):
    ...
    def get_cmd(self, environment, active_resources, working_dir='.', job_name='UnamedJob', job_id='1'):
        ...
        deepspeed_launch = [
            exports,
            "cd {};".format(os.path.abspath(working_dir)),
            sys.executable,
            "-u",
            "-m",
            ...
            "--env_style={}".format(self.env_style)
        ]
